...
<head>
    ...
    <style>
        ...
        #articles-section .pw-box {
            background-color: var(--pri-color);
            border-radius: 10px;
            overflow: hidden;
        }

        #articles-section .pw-box img {
            width: 100%;
            height: 280px;
        }
        ...
        #articles-section .text a.swipBtn {
            display: block;
            width: fit-content;
...
<body>
    ...
    <main>
                    ...
                    <div class="d-none d-md-block col-12 col-xl-11">
                        <nav class="mybreadcrumb" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active fw-bold" aria-current="page">مقالاتنا</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section id="articles-section" class="mb-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-10 col-md-12 col-lg-12 col-xl-11">
                        <h3 class="text-center mt-2"> مقالاتنا</h3>
                        ...
                        <div class="row justify-content-center justify-content-lg-start">
                                ...
                                <div class="pw-box mb-4">
                                    <a href="article.php">
                                        <div class="img-container">
                                            <img src="./imgs/afnan-fenmaktoob-600x424.jpg" alt="image">
                                        </div>
                                    </a>
                                    <div class="text">
                                        <h4>
                                        ...
                                        <a href="article.php" class="swipBtn ms-auto fw-bold">
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                                <div class="pw-box mb-4">
                                    <a href="article.php">
                                        <div class="img-container">
                                            <img src="./imgs/al-maslak-01-01-600x608.jpg" alt="image">
                                        </div>
                                    </a>
                                    <div class="text">
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                                <div class="pw-box mb-4">
                                    <a href="article.php">
                                        <div class="img-container">
                                            <img src="./imgs/للماقدمين-600x403.jpg" alt="image">
                                        </div>
                                    </a>
                                    <div class="text">
                                        <h4>
                                        ...
                                        <a href="article.php" class="swipBtn ms-auto fw-bold">
                                            المزيد <i class="fa-solid fa-chevron-left"></i> </a>
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                                <div class="pw-box mb-4">
                                    <a href="article.php">
                                        <div class="img-container">
                                            <img src="./imgs/Durba-reading-600x400.jpg" alt="image">
                                        </div>
                                    </a>
                                    <div class="text">
                                        <h4>
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                                <div class="pw-box mb-4">
                                    <a href="article.php">
                                        <div class="img-container">
                                            <img src="./imgs/إملاء2-15-600x404.jpg" alt="image">
                                        </div>
                                    </a>
                                    <div class="text">
                                        <h4>
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                                <div class="pw-box mb-4">
                                    <a href="article.php">
                                        <div class="img-container">
                                            <img src="./imgs/Tamhidy-kibar-600x400.jpg" alt="image">
                                        </div>
                                    </a>
                                    <div class="text">
                                        <h4>
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                                <div class="pw-box mb-4">
                                    <a href="article.php">
                                        <div class="img-container">
                                            <img src="./imgs/fenmaktoob-hat1-600x449.jpg" alt="image">
                                        </div>
                                    </a>
                                    <div class="text">
                                        <h4>
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                                <div class="pw-box mb-4">
                                    <a href="article.php">
                                        <div class="img-container">
                                            <img src="./imgs/قصة-وحوار7-600x400.jpg" alt="image">
                                        </div>
                                    </a>
                                    <div class="text">
                                        <h4>
                            ...
                            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                                <div class="pw-box mb-4">
                                    <a href="article.php">
                                        <div class="img-container">
                                            <img src="./imgs/العربية-للصغار-فنمكتوب3-15-600x557.jpg" alt="image">
                                        </div>
                                    </a>
                                    <div class="text">
                                        <h4>
