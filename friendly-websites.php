...
<body>
    ...
    <main>
                    ...
                    <div class="d-none d-md-block col-12 col-xl-11">
                        <nav class="mybreadcrumb" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active fw-bold" aria-current="page"> مواقع صديقة</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section id="websites-section" class="mt-3">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-11">
                        <h3 class="text-center mt-2"> مواقع صديقة</h3>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-11">
                        <div>
                            <strong>موقع منتج درجات : </strong>
                            <p><a href="#">http://www.darajat.org</a></p>
                            <strong>موقع منتج دندنة:</strong>
                            <p><a href="#">http://www.dandana.net
                                </a></p>
                            <strong>موقع خدمة أيّان:</strong>
                            <p><a href="#">ww.ayyan.org</a></p>
                        </div>
                    </div>
                </div>
            </div>
